...
describe("Menubar", () => {
  ...
  it("allows custom trigger and shortcut classes", () => {
    ...
    expect(screen.getByRole("menuitem", { name: "Edit" })).toHaveClass("custom-trigger")
  ...
  it("renders every menu item composition when opened", () => {
    ...
    expect(screen.getByText("Documents")).toHaveClass("custom-group-label", "pl-8")
    expect(screen.getByText("New")).toHaveClass("custom-item", "pl-8")
    expect(screen.getByText("Open")).not.toHaveClass("pl-8")
    expect(screen.getByText("Recent")).toHaveClass("custom-item-label", "pl-8")
    ...
    expect(screen.getByText("Email").parentElement).toHaveClass("custom-sub-content")
