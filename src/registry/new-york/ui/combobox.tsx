...
const ComboboxLabel = <T extends ValidComponent = "label">(
  ...
  return (
    <ComboboxPrimitive.Label class={cn(labelVariants(), local.class)} {...others} />
  )
}
...
const ComboboxItem = <T extends ValidComponent = "li">(
  ...
  return (
    <ComboboxPrimitive.Item
      class={cn(
        "relative flex cursor-default select-none items-center justify-between rounded-sm px-2 py-1.5 text-sm outline-none ui-disabled:pointer-events-none ui-highlighted:bg-accent ui-highlighted:text-accent-foreground ui-disabled:opacity-50",
        local.class
      )}
      {...others}
    />
...
const ComboboxInput = <T extends ValidComponent = "input">(
  ...
  return (
    <ComboboxPrimitive.Input
      class={cn(
        "flex size-full min-h-9 rounded-md bg-transparent py-2 text-base outline-none placeholder:text-muted-foreground disabled:cursor-not-allowed disabled:opacity-50",
        local.class
      )}
      {...others}
    />
