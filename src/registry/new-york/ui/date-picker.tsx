...
const DatePickerInput = (props: DatePickerPrimitive.InputProps) => {
  ...
  return (
    <DatePickerPrimitive.Input
      class={cn(
        "h-9 w-full rounded-md border border-border bg-background px-3 py-1 text-base shadow-sm transition-shadow placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-[1.5px] focus-visible:ring-ring disabled:cursor-not-allowed disabled:opacity-50",
        local.class
      )}
      {...others}
    />
  ...
  return (
    <DatePickerPrimitive.TableCellTrigger
      class={cn(
        ...
        "size-8 w-full p-0 font-normal ui-selected:opacity-100",
        "ui-today:bg-accent ui-today:text-accent-foreground",
        "[[data-today][data-selected]]:bg-primary [[data-today][data-selected]]:text-primary-foreground",
        "ui-selected:bg-primary ui-selected:text-primary-foreground ui-selected:hover:bg-primary ui-selected:hover:text-primary-foreground",
        "ui-disabled:text-muted-foreground ui-disabled:opacity-50",
        "ui-outsiderange]:text-muted-foreground ui-outsiderange]:opacity-50",
