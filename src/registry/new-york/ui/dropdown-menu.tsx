  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        class={cn(
          "z-50 min-w-32 origin-(--kb-menu-content-transform-origin) animate-content-hide overflow-hidden rounded-md border bg-popover p-1 text-popover-foreground shadow-md ui-expanded:animate-content-show",
          props.class
        )}
        {...rest}
      />
...
const DropdownMenuSubTrigger = <T extends ValidComponent = "div">(
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      class={cn(
        "flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none focus:bg-accent ui-state-open:bg-accent",
        props.class
      )}
      {...rest}
    >
