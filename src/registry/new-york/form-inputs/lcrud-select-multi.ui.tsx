...
export type LCRUDSelectMultiProps<TData extends CollectionDocument> = {
  /** Solid form wiring */
...
export default function LCRUDSelectMulti<TData extends CollectionDocument>(
  ...
  return (
    <Select<TData>
      ...
      itemComponent={(itemProps) => {
        ...
        const id = props.getOptionLabel(raw)
        ...
        return (
          ...
          >
            <Checkbox id={id} checked={props.value?.includes(raw)} />
    ...
    >
      ...
      >
        <SelectValue<TData> class="flex grow items-center justify-between gap-2 truncate">
          {(state) => (
            <>
              <div class="flex flex-wrap items-center gap-2 max-h-60 overflow-y-auto">
