    ...
    <Example title="ItemHeader">
      ...
      <Item variant="muted">
        ...
        <ItemContent>
          ...
          <ItemDescription>
            Complete reference guide for all available endpoints and authentication
            methods.
          </ItemDescription>
        </ItemContent>
      </Item>
    ...
    <Example title="ItemFooter">
      <Item>
        <ItemContent>
          ...
          <ItemDescription>
            Financial overview including revenue, expenses, and growth metrics for the
            fourth quarter.
          </ItemDescription>
        </ItemContent>
        <ItemFooter>
    ...
    <Example title="ItemHeader + ItemFooter">
      <Item>
        ...
        <ItemContent>
          ...
          <ItemDescription>
            Complete overhaul of the company website with modern design principles and
      ...
      <Item variant="outline">
        ...
        <ItemContent>
          ...
          <ItemDescription>
            Building a cross-platform mobile application for iOS and Android with React
            Native.
          </ItemDescription>
        </ItemContent>
        <ItemFooter>
