...
function AccordionWithBorders() {
  return (
    <Example title="With Borders">
      <Accordion class="mx-auto max-w-lg style-lyra:gap-2 style-nova:gap-2 style-vega:gap-2">
        <AccordionItem
          value="billing"
        ...
        >
          ...
          <AccordionContent class="style-lyra:px-2 style-maia:px-0 style-mira:px-0 style-nova:px-2.5 style-vega:px-4 style-lyra:text-xs style-nova:text-sm text-muted-foreground">
            ...
            beginning of each cycle, and you can cancel anytime. All plans include
            automatic backups, 24/7 support, and unlimited team members. There are no
        ...
        >
          ...
          <AccordionContent class="style-lyra:px-2 style-maia:px-0 style-mira:px-0 style-nova:px-2.5 style-vega:px-4 style-lyra:text-xs style-nova:text-sm text-muted-foreground">
            ...
            third-party security audits. All data is encrypted at rest and in transit
            using industry-standard protocols. We also offer optional two-factor
            authentication and single sign-on for enterprise customers.
          </AccordionContent>
        </AccordionItem>
        <AccordionItem
          value="integration"
        ...
        >
          ...
          <AccordionContent class="style-lyra:px-2 style-maia:px-0 style-mira:px-0 style-nova:px-2.5 style-vega:px-4 style-lyra:text-xs style-nova:text-sm text-muted-foreground">
            <p>
              ...
              HubSpot, and more. You can also build custom integrations using our REST
              API and webhooks.
            </p>
            <p>
            ...
            <AccordionItem value="upgrade">
              ...
              <AccordionContent>
                <p>
                  ...
                  be charged a prorated amount for the remainder of your billing cycle
                  and immediately gain access to new features.
                </p>
                <p>
            ...
            <AccordionItem value="cancel">
              ...
              <AccordionContent>
                <p>
                  ...
                  There are no cancellation fees or penalties. Your access will continue
                  until the end of your current billing period.
                </p>
                <p>
                  After cancellation, your data is retained for 30 days in case you want
                  to reactivate. You can export all your data before or after canceling.
                  We&apos;d love to hear your feedback about why you&apos;re leaving.
                </p>
              </AccordionContent>
            </AccordionItem>
        ...
        <For each={items}>
          {(item) => (
            ...
            >
              ...
              <AccordionContent class="style-lyra:px-2 style-nova:px-2.5 style-vega:px-4">
                {item.content}
              </AccordionContent>
            </AccordionItem>
          )}
