...
function InputGroupWithTooltip(props: {
  country: string
            ...
            <InputGroupAddon>
              <DropdownMenu>
                ...
                <DropdownMenuContent class="min-w-16">
                  <DropdownMenuItem onSelect={() => props.setCountry("+1")}>
                    +1
                  </DropdownMenuItem>
                  <DropdownMenuItem onSelect={() => props.setCountry("+44")}>
                    +44
                  </DropdownMenuItem>
                  <DropdownMenuItem onSelect={() => props.setCountry("+46")}>
                    +46
                  </DropdownMenuItem>
                </DropdownMenuContent>
              </DropdownMenu>
