...
function getPreviewColor(
  name: string,
  kind: "primary" | "muted-foreground" = "primary"
) {
...
export const BASE_COLORS: { name: BaseColor; label: string; color: string }[] = [
  {
    name: "neutral",
    label: "Neutral",
    color: getPreviewColor("neutral", "muted-foreground")
  },
  {
    name: "stone",
    label: "Stone",
    color: getPreviewColor("stone", "muted-foreground")
  },
  ...
  { name: "gray", label: "Gray", color: getPreviewColor("gray", "muted-foreground") },
  {
    name: "mauve",
    label: "Mauve",
    color: getPreviewColor("mauve", "muted-foreground")
  },
  {
    name: "olive",
    label: "Olive",
    color: getPreviewColor("olive", "muted-foreground")
  },
