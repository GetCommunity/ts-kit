...
export const ChangelogEntry = (props: ParentProps) => (
  <article
    ...
    class="mb-12 border-border border-b pb-12 last:border-b-0"
  >
    {props.children}
  </article>
)
  ...
  return (
    ...
    >
      <a
        ...
        class={cn(baseClass, "no-underline")}
        href={props.href}
      >
        <span class="text-muted-foreground text-xs">{props.date}</span>
        <span class="font-medium text-sm">{props.title}</span>
...
export const sharedComponents = {
  ...
  p: (props: ComponentProps<"p">) => {
    return (
      <p
        class="not-first:mt-6 text-base leading-relaxed dark:text-[#D4D4D4]"
        {...props}
      />
    )
  },
  ...
  Step: (props: ComponentProps<"h3">) => (
    <h3
      class="mt-8 scroll-m-32 font-heading font-medium text-lg tracking-tight"
      {...props}
    />
  ),
