...
function RouteComponent() {
  const [isFullLayout] = createSignal(false)
  ...
  return (
    <>
      ...
      <div
        data-slot="layout"
        class={cn(
          "relative z-10 flex h-svh flex-col overscroll-none bg-background antialiased contain-layout",
          "overflow-hidden",
      ...
      >
        ...
        >
          <div class="flex items-center lg:mr-2 xl:w-1/3">
            ...
            <div class="hidden font-medium text-muted-foreground text-sm lg:flex">
              Zaidan
            </div>
          </div>
          ...
          <div class="ml-auto flex items-center gap-2 md:justify-end xl:ml-auto xl:w-1/3">
            ...
            <SiteConfig
              ...
              onClick={() => switchLayout(!isFullLayout())}
            />
        ...
        <SidebarProvider class="overflow-x-hidden px-4 pt-15 pb-18 md:pb-4">
          ...
          <div
            ...
            class="flex basis-full flex-col gap-2 md:flex-row"
          >
            <Outlet />
