...
```tsx file=../../../registry/kobalte/examples/ui/chart-example.tsx#L56-L121
...
```tsx file=../../../registry/kobalte/examples/ui/chart-example.tsx#L123-L192
...
```tsx file=../../../registry/kobalte/examples/ui/chart-example.tsx#L194-L259
...
```tsx file=../../../registry/kobalte/examples/ui/chart-example.tsx#L261-L333
...
```tsx
import type { ECBasicOption } from "echarts/types/dist/shared"
import { ChartContainer, chartColors, chartLegendDefaults } from "~/components/ui/chart"
import {
  Card,
  CardContent,
  CardDescription,
...
```tsx file=../../../registry/kobalte/examples/ui/chart-example.tsx#L335-L419
