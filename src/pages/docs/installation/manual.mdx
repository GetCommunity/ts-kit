---
title: "Manual"
description: "How to manually install and configure Zaidan components in your SolidJS project."
slug: "manual"
parent: "installation"
---
...
```package-install
class-variance-authority clsx tailwind-merge lucide-solid tw-animate-css
```
...
```typescript title="lib/utils.ts" showLineNumbers
