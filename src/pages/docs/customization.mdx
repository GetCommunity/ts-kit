...
<Alert class="mt-4 border-none bg-amber-600/10 text-amber-600 dark:bg-amber-400/10 dark:text-amber-400">
  ...
  <AlertTitle class="text-amber-600/80 dark:text-amber-400/80">
    Shadcn does not handle the location for `css` files, so if you have a different
    structure, you'll need to adapt it to your project.
  </AlertTitle>
</Alert>
...
Zaidan provides 26 font families as registry items, spanning sans, serif, and monospace types. Each includes the Google Fonts `@import` rule and sets the `--font-sans`, `--font-serif`, or `--font-mono` CSS variable:
